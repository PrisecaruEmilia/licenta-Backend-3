                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li
                                            ...
                                            <span class="text-secondary">https://localhost:3000</span>
                                        </li>
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                            ...
                                            <span class="text-secondary">@splashshop</span>
                                        </li>
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="formFile" class="form-label">Încarcă imaginea de profil</label>
                                        <input class="form-control" type="file" id="formFile">
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-3"></div>
                                        <div class="col-sm-9 text-secondary">
                                            <input type="button" class="btn btn-primary px-4" value="Salvează schimbările">
                                        </div>
                                    </div>
                                </div>
                            </div>
